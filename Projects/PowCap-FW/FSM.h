...
#define GAIN1    'g'
#define GAIN2    'G'
#define FILTER1  'f'	//voltage  filter designation
#define FILTER2  'F'	//current filter designation
#define NOTCH1	 'n'	//voltage notch filter designation
#define NOTCH2   'N'	//current notch filter designation
#define NUMBER_CMDS 5

#define VALIDCMD(c) (((c)==(GAIN1)) || ((c)==(GAIN2)) || ((c)==(FILTER1)) || ((c)==(FILTER2)) || ((c)==(NOTCH1)) || ((c)==(NOTCH2)))
